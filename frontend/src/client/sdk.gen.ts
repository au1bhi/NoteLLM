...
export class StudyPlansService {
     ...
     * @param data.limit
     * @param data.notebookId
     * @returns StudyPlansPublic Successful Response
     * @throws ApiError
     */
    public static readStudyPlans(data: StudyPlansReadStudyPlansData = {}): CancelablePromise<StudyPlansReadStudyPlansResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static aiAdjustPlan(data: StudyPlansAiAdjustPlanData): CancelablePromise<StudyPlansAiAdjustPlanResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/study-plans/{plan_id}/ai-adjust',
            path: {
                plan_id: data.planId
            },
            body: data.requestBody,
