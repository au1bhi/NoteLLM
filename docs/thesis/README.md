...
学校正式稿用学校模板。本目录是对着当前仓库写成的章节草稿，避免把实现章写成泛化 RAG 综述、或把模板截图贴进正文。
...
| [chapter-implementation.md](chapter-implementation.md) | 第 4 章　关键实现 |
| [chapter-security.md](chapter-security.md) | 第 5 章　安全 |
...
基线数字只引用 `docs/evaluation/latest-results.md`（2026-07-23，`cb0ead1`）。消融与三种模式的空表在实跑前保持「—」。示例主机只用 RFC 2606。
